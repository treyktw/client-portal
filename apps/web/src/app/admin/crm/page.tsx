...
const modalReducer = (state: ModalState, action: ModalAction): ModalState => {
  switch (action.type) {
    ...
    case "OPEN_OUTREACH":
      return {
        ...state,
        quickOutreach: { open: true, contact: action.contact },
      };
    case "CLOSE_OUTREACH":
  ...
  const filteredContacts = useMemo(() => {
    ...
    if (filters.hasEmail !== null) {
      filtered = filtered.filter((c) => {
        const hasValidEmail = c.emails.some(
          (e) => e.emailConsent !== "opted_out"
        );
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Select
          ...
          onValueChange={(value) =>
            filterDispatch({
              type: "SET_STATUS",
              payload: value as import("@/types/crm").ContactStatus | "all",
            })
          }
        >
        ...
        <Select
          ...
          onValueChange={(value) =>
            filterDispatch({
              type: "SET_TYPE",
              payload: value as import("@/types/crm").ContactType | "all",
            })
          }
        >
          <SelectTrigger className="w-[140px]">
        ...
        <Select
          ...
          onValueChange={(value) =>
            filterDispatch({
              type: "SET_SOURCE",
              payload: value as import("@/types/crm").ContactSource | "all",
            })
          }
        >
          <SelectTrigger className="w-[140px]">
            ...
            {filteredContacts.length === 0 ? (
              ...
              filteredContacts.map((contact) => (
                  ...
                  >
                    ...
                    >
                      <Link href={`/admin/crm/${contact._id}`}>
